...
- [ ] **Skill Evals & Test Cases** — create `company-research/evals/evals.json` with 3–5 realistic test prompts and assertions covering: PARALLEL vs. SEQUENTIAL mode selection, ICP score output format, BD Briefing completeness, and Checker criteria enforcement — no automated regression path exists for a 1,165-line skill *(audit finding: "no evals/ directory; no test cases or assertions exist")*
